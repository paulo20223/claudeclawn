  ...
  <aside class="settings-modal" id="settings-modal" aria-live="polite">
    ...
    <div class="settings-stack">
      <div class="setting-item">
        ...
        <button class="toggle-btn" id="clock-toggle" type="button">24h</button>
      </div>
      <div class="setting-item">
        <div class="setting-main">
        ...
        <button class="toggle-btn on" id="info-open" type="button">Info</button>
      </div>
    </div>
  </aside>
  ...
  ▝▜█████▛▘
    ▘▘ ▝▝</pre>
      ...
      <div class="section-tabs" id="section-tabs">
        <button class="section-tab active" type="button" data-tab="jobs">Jobs</button>
        <button class="section-tab" type="button" data-tab="skills">Skills</button>
      </div>
      <section class="quick-job" id="quick-jobs-view">
        ...
        <div class="jobs-pagination" id="jobs-pagination"></div>
      </section>
      ...
      <section class="quick-job quick-view-hidden" id="skills-view">
        <div class="quick-job-head quick-job-head-row">
          <div>
            <div class="quick-job-title">Skills</div>
            <div class="quick-job-sub">Custom skills loaded from skills directory</div>
          </div>
          <button class="quick-open-create" id="skill-open-create" type="button">Create Skill</button>
        </div>
        <div class="quick-jobs-list quick-jobs-list-main" id="skills-list">
          <div class="quick-jobs-empty">Loading skills...</div>
        </div>
        <div class="quick-status" id="skills-status"></div>
      </section>
      <form class="quick-job quick-view-hidden" id="skill-create-form">
        <div class="quick-job-head">
          <div class="quick-job-title">Create Skill</div>
          <div class="quick-job-sub">Add a custom skill for Claude</div>
        </div>
        <div class="skill-guide">
          A skill is a set of instructions that Claude follows for specific tasks.
          Give it a clear name, a short description (used to decide when to activate),
          and write the full instruction content below.
        </div>
        <div class="skill-form-fields">
          <div class="quick-field">
            <div class="quick-label">Name</div>
            <input class="quick-input" id="skill-name-input" type="text" placeholder="my-skill" pattern="[a-zA-Z0-9_-]+" required />
          </div>
          <div class="quick-field">
            <div class="quick-label">Description</div>
            <input class="quick-input" id="skill-desc-input" type="text" placeholder="Short description of when to use this skill" required />
          </div>
          <div class="quick-field">
            <div class="quick-label">Content</div>
            <textarea class="quick-prompt" id="skill-content-input" placeholder="Write the skill instructions here..."></textarea>
          </div>
        </div>
        <div class="quick-job-actions">
          <button class="quick-submit" id="skill-submit" type="submit">Create Skill</button>
          <div class="quick-status" id="skill-form-status"></div>
        </div>
        <div class="quick-form-foot">
          <button class="quick-back-jobs" id="skill-back-list" type="button">Back to Skills</button>
        </div>
      </form>
    </section>
  </main>
